...
namespace ca.HenrySoftware.Flop
{
	public class Intro : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			Ease3.GoScale(this, _logo.gameObject, _logo.transform.localScale, new Vector3(2f, 2f, 1f), _timeAnimation, EaseType.BounceOut, _timeDelay);
			Ease3.GoRotation(this, _logo.gameObject, new Vector3(0f, 0f, 180f), _timeAnimation, EaseType.BounceOut, _timeDelay);
