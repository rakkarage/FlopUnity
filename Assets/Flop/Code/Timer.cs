...
namespace ca.HenrySoftware.Flop
{
	public class Timer : MonoBehaviour
	{
		...
		public void Slow()
		{
			...
			Ease3.GoScaleBy(_statusSlow, new Vector3(-.333f, .333f, 0f), .333f, null, null, EaseType.BackInOut, 0f, 1, true, true);
		}
		public void Pause()
		{
			Time.timeScale = (_pause = !_pause) ? 0f : _slow ? .1f : _fast ? 2f : 1f;
			Ease3.GoColorTo(_statusPause, (_pause ? _colorOn : _colorOff).GetVector(), .333f, i => { _statusPause.color = i.GetColor(); }, null, EaseType.Linear, 0f, 1, false, true);
			Ease3.GoScaleBy(_statusPause, new Vector3(.333f, .333f, 0f), .333f, null, null, EaseType.BackInOut, 0f, 1, true, true);
		}
		public void Fast()
		{
			_slow = false;
			...
			Ease3.GoScaleBy(_statusFast, new Vector3(.333f, .333f, 0f), .333f, null, null, EaseType.BackInOut, 0f, 1, true, true);
		}
	}
}
